            ...
            if (sesion != null && usuario != null) {
               ...
               final Part fileP = request.getPart("file");
                ...
                final FormDataMultiPart multipart = (FormDataMultiPart) formDataMultiPart
                        ...
                        .field("filenameOld", filenameOld, MediaType.TEXT_PLAIN_TYPE)
                        .field("filenameOld2", filenameOld2, MediaType.TEXT_PLAIN_TYPE)
                        .bodyPart(filePart);
               
                final WebTarget target = client.target("http://localhost:8080/Practica4_REST/resources/javaee8/modify");
