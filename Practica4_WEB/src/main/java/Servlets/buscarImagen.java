            ...
            if (sesion != null && usuario != null) {
                ...
                if (title.isEmpty() && description.isEmpty() && key.isEmpty() && author.isEmpty() && captureDate.isEmpty()) {
                   ...
                   rd.forward(request,response);
                    ...
                    if(combinada2) {
                        List<Image> imagenes;
                        URL url = new URL("http://localhost:8080/Practica4_REST/resources/javaee8/combinedSearch");
                    ...
                    //CASO DE QUE SOLO HAYA UN CAMPO DE FILTRADO DE BÚSQUEDA.
                         ...
                         if (!title.isEmpty()) {
                            URL url = new URL("http://localhost:8080/Practica4_REST/resources/javaee8/searchTitle/"+title);
                            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                           ...
                           if (!imagenes.isEmpty()) {
                            ...
                            URL url = new URL("http://localhost:8080/Practica4_REST/resources/javaee8/searchKeywords/"+key);
                            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                            conn.setRequestMethod("GET");
                            InputStreamReader in = new InputStreamReader(conn.getInputStream());
                            BufferedReader br = new BufferedReader(in);
                           ...
                           if (!imagenes.isEmpty()) {
                            ...
                            URL url = new URL("http://localhost:8080/Practica4_REST/resources/javaee8/searchAuthor/"+author);
                            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                            conn.setRequestMethod("GET");
                            InputStreamReader in = new InputStreamReader(conn.getInputStream());
                            BufferedReader br = new BufferedReader(in);
                           ...
                           if (!imagenes.isEmpty()) {
                            ...
                            URL url = new URL("http://localhost:8080/Practica4_REST/resources/javaee8/searchCreationDate/"+captureDate);
                            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                            conn.setRequestMethod("GET");
                            InputStreamReader in = new InputStreamReader(conn.getInputStream());
                            BufferedReader br = new BufferedReader(in);
